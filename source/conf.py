...
latex_documents = [
  ('index', 'CloudStackAdministrationDocumentation.tex', u'CloudStack Administration Documentation',
...
man_pages = [
    ('index', 'cloudstackadministrationdocumentation', u'CloudStack Administration Documentation',
